...
由于官方（MaibaoAPI）目前只做了 Dify 的节点，完全忽视了我们 n8n 用户的感受。因此，本项目诞生了！

作者本人**完全没有代码基础**，全靠 **Gemini和Claude** 鼎力赞助完成，（对我来说）很好用！
...
3. **节点配置：** 选择凭证 → 选择模式（文本生成/图像生成/视频生成/向量嵌入）→ 填好其它两三个参数（模型 ID、提示词等）→ OJ8K 完事！
